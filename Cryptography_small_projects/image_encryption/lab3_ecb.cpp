...
int main(void) {
  ...
  const char cipherName[] = "aes-128-ecb";
...
////////////////
  ...
  FILE *f2 = fopen("Mad_scientist_encrypted_ecb.bmp","w+b");
...
ctLength += tmpLength;
  ...
  FILE *f3 = fopen("Mad_scientist_decrypted_ecb123.bmp","wb");
